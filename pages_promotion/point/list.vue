								...
								<view class="goods-item " v-for="(item, index) in goodsList" :key="index">
									...
									<view class="info-wrap">
										...
										<view class="pro-info" v-if="item.stock_show || item.sale_show ">
											<view class="font-size-activity-tag color-tip" v-if="item.stock_show ">库存:{{ item.stock }}</view>
											<view class="font-size-activity-tag color-tip sale" v-if="item.sale_show ">已兑:{{ item.sale_num }}</view>
										</view>
									</view>
								</view>
							</view>
