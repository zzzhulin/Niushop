<template>
	...
	<view class="apply">
		...
		<view v-if="status === ''">
			...
			<view class="empty" v-else-if="basicsConfig.is_apply == 0">
				<block v-if="fenxiaoConfig.fenxiao_condition == 2 || fenxiaoConfig.fenxiao_condition == 3">
					...
					<text v-if="fenxiaoConfig.fenxiao_condition == 3">申请成为{{ fenxiaoWords.fenxiao_name }},需要您的消费金额需要达到{{ fenxiaoConfig.consume_money|moneyFormat }}元</text>
				</block>
