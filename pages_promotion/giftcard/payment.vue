<template>
	...
	<view class="order-container" :class="{ 'safe-area': isIphoneX }">
			...
			<view class="site-body" v-if="orderPaymentData">
				...
				<view class="buy-num-box">
					<view class="order-cell">
						...
						<view class="box"><uni-number-box :min="min" :value="orderPaymentData.num" size="small" :modifyFlag="modifyFlag" @change="cartNumChange($event)" /></view>
					</view>
				</view>
			</view>
		</view>
		...
		<view class="order-submit" :class="{ 'bottom-safe-area': isIphoneX }">
			...
			<view class="submit-btn"><button type="primary" size="mini" @click="openChoosePayment()">立即支付</button></view>
		</view>
