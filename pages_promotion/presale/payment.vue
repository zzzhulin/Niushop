	...
	<view class="order-container" :class="{ 'safe-area': isIphoneX }">
						...
						<view class="info-wrap local" v-if="localMemberAddress" @click="selectAddress">
							<view class="content">
								...
								<view class="desc-wrap">
									{{ localMemberAddress.full_address ? localMemberAddress.full_address : '' }} {{ localMemberAddress.address ? localMemberAddress.address : '' }}
								</view>
							</view>
						</view>
		...
		<uni-popup ref="presaleAgreement" type="center">
			<view class="agreement-wrap">
				...
				<view class="popup-footer"><view class="confirm-btn color-base-bg" @click="closePresaleAgreement">确定</view></view>
			</view>
		</uni-popup>
				...
				<scroll-view scroll-y="true" class="popup-body" :class="{ 'safe-area': isIphoneX }">
					...
					>
						<view class="coupon-info">
							<view class="info-wrap" :style="{ backgroundImage: 'url(' + $util.img('public/uniapp/coupon/bg_lingqu.png') + ')' }">
