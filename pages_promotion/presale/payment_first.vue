	...
	<view class="order-container" :class="{ 'safe-area': isIphoneX }">
		...
		<view class="payment-top ns-bg-color">
			<view class="order-status-left">
				...
				<image :src="$util.img(action.icon)" mode=""></image>
			...
			<view class="delivery-box" >
				<view>
					<view class="store-info">
						<view class="icon ns-bg-color"><view class="iconfont icon-dingwei1 ns-font-size-lg"></view></view>
			...
			<!-- <view class="delivery-box" v-if="orderPaymentData.is_virtual == 0 && orderPaymentData.delivery.delivery_type == 'store'">
				<view>
					<view @click="openSiteDelivery" class="store-info" v-if="storeInfo.currStore">
						<view class="icon ns-bg-color" v-if="!storeInfo.currStore.store_image"><view class="iconfont icon-mendian"></view></view>
		...
		<!-- <view class="mobile-wrap" v-if="orderPaymentData.is_virtual == 1">
			<view class="icon ns-bg-color"><view class="iconfont icon-shouji1 ns-font-size-xx-lg"></view></view>
		...
		<uni-popup ref="invoicePopup" type="bottom">
			<view :style="orderCreateData.is_invoice == 1 ? 'height: 83vh;' : 'height: 48vh;'" class="invoice-popup popup" @touchmove.prevent.stop>
				<view class="popup-header">
					...
					<view class="align-right"><text class="iconfont icon-close uni-bold" @click="closeInvoicePopup()"></text></view>
				</view>
		...
		<uni-popup ref="couponPopup" type="bottom">
			<view class="coupon-popup popup" @touchmove.prevent.stop>
				<view class="popup-header">
					...
					<view class="align-right"><text class="iconfont icon-close uni-bold" @click="closePopup('couponPopup')"></text></view>
				</view>
				<scroll-view scroll-y="true" class="popup-body" :class="{ 'safe-area': isIphoneX }">
					<view
						class="coupon-item"
					...
					>
						<view class="iconfont" :class="orderPaymentData.coupon.coupon_id == couponItem.coupon_id ? 'icon-yuan_checked ns-text-color' : 'icon-yuan_checkbox'"></view>
		...
		<uni-popup ref="sitePromotionPopup" type="bottom">
			<view class="promotion-popup popup">
				<view class="popup-header">
					...
					<view class="align-right"><text class="iconfont icon-close uni-bold" @click="closePopup('sitePromotionPopup')"></text></view>
				</view>
				<scroll-view scroll-y="true" class="popup-body" :class="{ 'safe-area': isIphoneX }">
					<view>
						<view class="order-cell">
		...
		<uni-popup ref="deliveryPopup" type="bottom">
			<view class="delivery-popup popup">
				<view class="popup-header">
					...
					<view class="align-right"><text class="iconfont icon-close uni-bold" @click="closePopup('deliveryPopup')"></text></view>
				</view>
				<view class="popup-body store-popup" :class="{ 'safe-area': isIphoneX }">
					<view class="delivery-cell delivery-cont">
						<view class="pickup-point" v-for="(item, index) in storeInfo.storeList" :key="index" @click="selectPickupPoint(item)">
							...
							<view class="icon" v-if="item.store_id == orderPaymentData.delivery.store_id"><text class="iconfont icon-yuan_checked ns-text-color"></text></view>
						</view>
